...
def envoiMailSiErreurLOG(depart, mdp, arrivee, nomfichier, temps): # adresse mail départ, mot de passe, adresse mail arrivée, info sur le field test et date de l'erreur, l'heure de l'erreur
    fromaddr = depart
    toaddr = arrivee
    msg = MIMEMultipart()
    msg['From'] = fromaddr
    ...
    print("le message d'alerte a bien été envoyé à l'adresse "+arrivee)
    server.quit()